	...
	<div class="col-6 mx-auto" > <!--ГЛАВНЫЙ БЛОК-->
		<div class="row"> 
			...
			<div class="col-8 px-0 my-2"> 
				...
				<!--САМ ПОСТ-->
				<?php 
					$insta = mysqli_connect('MySQL-8.2', 'root','','insta');
					$query = mysqli_query($insta, "SELECT * FROM posts");
				?>
				...
				<div class="mt-5 border rounded">   
					...
					<div class="col-12 py-2">  <!--текстовые элементы поста-->
						...
						<div>
							<p><?php echo $stroka['texts']; ?></p>
						</div>
						<div>
							<p>5 недель назад</p>
						</div>						
					</div>
					<button class="btn btn-primary button" style="display: block;">Редактировать</button>
					<form action="update.php" method="GET" class="form" style="display: none;">
					<input type="hidden" name="id" placeholder="id" value="<?php echo $stroka['id'] ?>">
